...
| auto_sync_up_delay | An integer value specifying the delay in seconds between attempts to upload scans to the server. Only for <i>AutoSync</i> services. |
| auto_sync_down_delay | An integer value specifying the delay in seconds between attempts to download database from server. Only for <i>AutoSync</i> services. |
