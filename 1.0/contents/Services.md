...
* <b>service_name</b> - a string which specifies the desired name of your new service. The default is <code>Service $i</code>, where $i is the next available sequential number.
